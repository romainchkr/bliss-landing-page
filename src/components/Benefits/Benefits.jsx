    ...
    return (
        <Box component="section" className="bloc section-black" bgcolor="var(--secondary)">
            <Box component="div" width={{xs: '90%'}} margin='auto'>
                ...
                <Box className="atoutwrap" flexDirection={{xs: 'column', md: 'row'}} gap={{xs: "30px", md: "60px"}}>
                    <BenefitBlock img={emojiSnowFlake} title="Brise la glace" content="Fini les “Salut ça va ?” Grâce aux jeux de questions engage des conversations intéressantes et spontanées" />
